...
![Joe's talk a few hours ago](images/paste-3.png){.rounded-shadow fig-align="center" width="25%"}
...
::: {.column width="60%"}
<br>
LLMs are _fantastic_ at converting unstructured text to [structured data]{.yellow}.
:::
